const TEMPLATES = {
  lonja_offer: "Hola! Vi la oferta de {vehicle} para mi búsqueda en La Lonja de Stockar (presupuesto ${budget}). ¿Podemos hablar?",
  pre_toma_acceptance: "Hola! Me escribo por la Pre Toma del {vehicle} que publicaste en Stockar. Estoy interesado/a. ¿Podemos hablar?",
